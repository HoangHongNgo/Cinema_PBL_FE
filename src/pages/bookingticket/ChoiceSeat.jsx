                    ...
                    <div className="cardticket-body">
                        <div className="rowticket">
                            <div className="col-ticket">
                                ...
                                <p className="textticket text-truncate" >
                                    Suất
                                    <strong className="marginticket-left">20:30</strong>
                                     - Hôm nay,
                                     <strong> 22/05 </strong>
                                </p>
                                <p className="textticket text-truncate" >
                                    ...
                                    <div className=" seats seats-map">
                                        { Object.entries(groupedSeats).map(([seatRow, seatsInRow])=>(
                                            <div key={seatRow}  >
                                                ...
                                                {seatsInRow.map((seat)=>(
                                                    <div className="row-wrapper">
                                                        <ul key={seat.id} className={`seat-row ${selectedSeats.includes(seat) ? 'choice' : ''}`} 
                                                         onClick={() => handleSeatClick(seat)}>
                                                            <li className="textticket">{seat.seat_num}</li>
